    ...
    btn.addEventListener("click", () => {
      ...
      send.addEventListener("click", async () => {
        ...
        try {
          ...
          btn.disabled = true;
          btn.textContent = out.updated
            ? "Updated — " + count + " of you"
            : "You're down for " + count;
        } catch (err) {
          st.className = "st err";
